    ...
    fun securityFilterChain(http: HttpSecurity) : SecurityFilterChain {
        ...
        return http
            ...
            .authorizeHttpRequests { auth -> auth
                ...
                // Endpoints autorizados (usuarios autenticados)
                ...
                .requestMatchers(HttpMethod.GET,"/usuarios/self/gamedata").authenticated()
                .requestMatchers(HttpMethod.PUT,"/usuarios/self/gamedata").authenticated()
                ...
                .requestMatchers(HttpMethod.GET,"/usuarios/{username}/gamedata").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PUT,"/usuarios/{username}/gamedata").hasRole("ADMIN")
